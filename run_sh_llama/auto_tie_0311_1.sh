...
train_model "llama_epl_apa_mtp_w3e-1_0311" "True" "2e-5" "aug-wo-pc-apa-mtp" "./configs/epl_apa_mtp.json" "apa_mtp" "8192"
if [ $? -ne 0 ]; then
    echo "❌ llama_epl_apa_mtp_w3e-1_0311训练失败，退出"
    exit 1
fi
inference_and_evaluate "llama_epl_apa_mtp_w3e-1_0311" "anchor-thought" "inference" "./configs/LightThinker/llama/apa_mtp.json"

# ==================== 模型: llama_lightThinker ====================
train_model "llama_epl_apa_0311" "True" "2e-5" "aug-wo-pc" "None" "adaptive_v1" "4096"
if [ $? -ne 0 ]; then
    echo "❌ llama_epl_apa_0311训练失败，退出"
    exit 1
fi
inference_and_evaluate "llama_epl_apa_0311" "anchor-thought" "inference" "./configs/LightThinker/llama/adaptive_v1.json"
