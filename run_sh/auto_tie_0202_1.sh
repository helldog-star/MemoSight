...
# ==================== 模型1: epl_adaptive_mtp_aux_cross_attn_E_w1e-2 ====================
train_model "epl_adaptive_mtp_aux_cross_attn_E_w1e-2" "True" "2e-5" "aug-wo-pc" "configs/epl_adaptive_mtp_aux_cross_attn_E_w1e-2.json" "adaptive_v1"
if [ $? -ne 0 ]; then
    echo "❌ epl_adaptive_mtp_aux_cross_attn_E_w1e-2训练失败，退出"
    exit 1
fi

inference_and_evaluate "epl_adaptive_mtp_aux_cross_attn_E_w1e-2" "anchor-thought" "inference" "./configs/LightThinker/qwen/adaptive_v1.json"
