...
# ==================== 模型: epl_apa_mtp_w3e-1_v2 ====================
train_model "epl_apa_mtp_w3e-1_v2" "True" "2e-5" "aug-wo-pc-apa-mtp" "configs/epl_apa_mtp.json" "apa_mtp"
if [ $? -ne 0 ]; then
    echo "❌ epl_apa_mtp_w3e-1_v2训练失败，退出"
    exit 1
fi
inference_and_evaluate "epl_apa_mtp_w3e-1_v2" "anchor-thought" "inference" "./configs/LightThinker/qwen/apa_mtp.json"
