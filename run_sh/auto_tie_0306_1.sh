...
# ==================== 模型: apa_mtp_w3e-1(w/o-epl) ====================
train_model "apa_mtp_w3e-1_wo-epl" "False" "2e-5" "aug-wo-pc-apa-mtp" "configs/epl_apa_mtp.json" "apa_mtp" "8192"
if [ $? -ne 0 ]; then
    echo "❌ apa_mtp_w3e-1_wo-epl训练失败，退出"
    exit 1
fi
inference_and_evaluate "apa_mtp_w3e-1_wo-epl" "anchor-thought" "inference" "./configs/LightThinker/qwen/apa_mtp.json"


# ==================== 模型: epl_mtp_w3e-1(w/o-apa) ====================
train_model "epl_mtp_w3e-1_wo-apa" "True" "2e-5" "aug-wo-pc-apa-mtp" "configs/epl_apa_mtp.json" "v1" "8192"
if [ $? -ne 0 ]; then
