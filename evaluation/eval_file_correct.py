...
class Evaluator:
    ...
    def metrics2str(self, metrics:Dict) -> str:
        if len(metrics['compress_list']) != 0:
            freq_path=f'eval_results/{self.args.method}/{self.args.model_type}/{self.args.dataset}/frequency.jsonl'
        ...
        result_path=f'eval_results/{self.args.method}/{self.args.model_type}/{self.args.dataset}/result.txt'
