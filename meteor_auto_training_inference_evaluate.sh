...
# bash ./meteor_train_lightthinker.sh
# echo "=======🚀 lightthinker结束训练 ======="

# echo "=======🚀 lightthinker开始推理 ======="
# bash ./meteor_inference.sh
...
# bash meteor_evaluate.sh --method anchor-thought --dataset bbh --base_path ${output_tag}/bbh
# bash meteor_evaluate.sh --method anchor-thought --dataset gpqa --base_path ${output_tag}/gpqa
# bash meteor_evaluate.sh --method anchor-thought --dataset gsm8k --base_path ${output_tag}/gsm8k
# bash meteor_evaluate.sh --method anchor-thought --dataset mmlu --base_path ${output_tag}/mmlu
# echo "=========================================="
...
ckpt="1305"
output_tag="${output_path}/${model_tag}/inference"
bash meteor_evaluate.sh --method normal --dataset bbh --base_path ${output_tag}/bbh
bash meteor_evaluate.sh --method normal --dataset gpqa --base_path ${output_tag}/gpqa
bash meteor_evaluate.sh --method normal --dataset gsm8k --base_path ${output_tag}/gsm8k
bash meteor_evaluate.sh --method normal --dataset mmlu --base_path ${output_tag}/mmlu
echo "=========================================="
echo "      🚀 vanilla评估完成      "
echo "=========================================="