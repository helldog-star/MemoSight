...
MODEL_PATH = "/mnt/jinbo/RLRM/model/checkpoint-1044"
CONFIG = "/mnt/lxy/MemoSight/configs/LightThinker/qwen/adaptive_v1.json"
MAX_NEW = 320
MAX_PROMPT = 256
DEVICE = "cuda"
...
print("attn_impl:", model.config._attn_implementation, "vocab:", model.get_input_embeddings().weight.shape[0])
